...
const AddMembers = ({ navigation }) => {
    ...
    const add = () => {
        ...
        if (stateImage != null && stateData.firstName != '' &&
            ...
            stateData.email != '' && stateData.password != '' && statePhoneNo != ''
        ...
        <SafeAreaView style={STYLES.withoutpaddingcontainer}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={{ marginTop: '10%' }}>
                    ...
                    <View style={{
                        flexDirection: 'row',
                        borderWidth: 1, borderColor: COLORS.grey707070,

                        marginHorizontal: '10%', marginTop: '3%'
                        ...
                        <TouchableOpacity
                            ...
                            />
                            <SvgXml xml={Svgs.arrowDown} style={{ marginRight: '3%', height: '5%' }} />
                        </TouchableOpacity>
                        <TextInput style={{
